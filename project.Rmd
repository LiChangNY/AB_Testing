...
* Number of user-ids: A user-ids is bigger than a cookie, so it’s neither invariant nor evaluation metric. 
...
* Gross conversion(#enrollment/#clicks): Evaluation metrics. If the hypothesis holds true, the free-trial screener would turn away some students that are unable to commit more than 5 hours a week. Therefore, I might expect a lower gross conversion rate in the experiment group than the control group. 

* Retention (#payment/#enrollment): It’s a potential evaluation metrics but I ended up not using it because of unrealistic requirement for minimum pageviews. Had I used it as an evaluation metric, I would expect this metric to be higher in the experiment group because, though both number of payments and enrollments are reduced in the experiment group than control group, the magnitude of decrease in payment should be smaller than that in enrollments.

* Net conversion(#payment/#clicks): This is an evaluation metrics but a tricky one because I would actually want the difference between control and experiment group to be statistically insignificant. In other words, although the free-trial screener results in fewer enrollments (because less-committing students are not enrolling), the number of students who continue after the free trial period should be the same between control and experiment group, which aligns with the goal"—without significantly reducing the number of students to continue past the free trial and eventually complete the course."
...
Both of my evaluation metrics are ratios with clicks as the denominator, so unit of analysis is not the unit of diversion, which would result in a higher variability had I used empirical method. If number of cookies or clicks had been my evaluation metrics, empirical estimate would be more appropriate.
...
Therefore, I dropped retention from the design but instead used Bonferroni, to be more conservative and account for the correlation between gross conversion and net conversion. The result show that it would only require 822,625 pageviews. 
...
The confidence interval for net conversion [-0.0126, 0.0028] includes both 0 and practical significance boundary (dmin = 0.0075). Hence, the difference on net conversion is neither statistically nor practically significant. 
...
Gross conversion measures #enrollment/#clicks and net conversion #payment/#clicks. My experiment used Bonferroni correction because the two metrics are highly correlated. 
...
The experiment hypothesis states that the goal of the screener is to "set clearer expectations for students upfront, thus reducing the number of frustrated students who left the free trial because they didn't have enough time—without significantly reducing the number of students to continue past the free trial and eventually complete the course. " The experiment result shows that, indeed, gross conversion is lower in the experiment group, meaning that fewer people are signing up after clicking on the free-trial button. Who are those people that opted out signing up? They might be people who would likley feel frustrated, had they signed up for the free trial but not able to continue past the 14-day period. Anyway, even with a lower enrollment, it doesn't affect the net conversion at all, which aligns with the second half of the hypothesis—without significantly reducing the number of students to continue past the free trial. 

Therefore, I wouldn’t object to launching this experiment because it satisfied the short-term goal of this experiment. However, the long-terms goal is to “improve the overall student experience and improve coaches' capacity to support students who are likely to complete the course.” This can’t be measured in this experiment but only through a follow up study. A satisfaction survey should suffice for measuring students’ experience. If hypothesis holds true, we should expect to see a higher satisfaction level in the experiment group. As to the latter, we can measure number of questions per enrolled student that were posted in the forum and tagged as “free-trial” or “free-trial cancellation”. If hypothesis holds true, we should expect to see a lower ratio of questions per student. 
...
The initial diversion is a cookie on the enrollment confirmation page. After that, a user-id is used to track if a student remain enrolled past the 14-day boundary. 
...
* Number of cookies: The number of unique cookies to view the “You are enrolled in the free-trial” confirmation page. This is an invariant metric because it’s before the invitation page shows up. 
